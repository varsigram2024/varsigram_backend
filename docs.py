...
# api/v1/ organizations/<str:username>/follow/ [name='follow-organization'] : This endpoint is used to follow the organization.

# api/v1/ organizations/<str:username>/unfollow/ [name='unfollow-organization'] : This endpoint is used to unfollow the organization.

# api/v1/ following/ [name='following-organizations'] : This endpoint is used to view the following organizations.

# api/v1/ organizations/<str:username>/followers/ [name='organization-followers'] : This endpoint is used to view the organization's followers.